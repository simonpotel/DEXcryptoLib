...
abiQuickswap = GetJSONConfig('BlockchainLib/Lib/Routers/quickswap_abi.json')

aUniswap = '0xE592427A0AEce92De3Edee1F18E0157C05861564' #_factory (address): x
abiUniswap = GetJSONConfig('BlockchainLib/Lib/Routers/uniswap_abi.json')